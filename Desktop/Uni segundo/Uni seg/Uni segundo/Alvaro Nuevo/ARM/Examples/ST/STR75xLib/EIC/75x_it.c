...
{
  /* Toggle led connected to P0.16 pin */
  GPIO_WriteBit(GPIO0, GPIO_Pin_16, (BitAction)((1-GPIO_ReadBit(GPIO0, GPIO_Pin_16))));
...
{
  /* Toggle led connected to P2.19 pin */
  GPIO_WriteBit(GPIO2, GPIO_Pin_19, (BitAction)((1-GPIO_ReadBit(GPIO2, GPIO_Pin_19))));
...
{
  /* Toggle led connected to P2.18 pin */
  GPIO_WriteBit(GPIO2, GPIO_Pin_18, (BitAction)((1-GPIO_ReadBit(GPIO2, GPIO_Pin_18))));
