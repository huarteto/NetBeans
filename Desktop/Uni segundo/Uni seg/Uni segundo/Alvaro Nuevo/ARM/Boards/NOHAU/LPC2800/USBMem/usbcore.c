...
void USB_SetupStage (void) {
  USB_ReadSetupEP0((BYTE *)&SetupPacket);
}
    ...
    case REQUEST_TO_DEVICE:
      switch (SetupPacket.wValue.WB.H) {
        ...
        case USB_DEVICE_QUALIFIER_DESCRIPTOR_TYPE:
          if (USB_HighSpeed) {
            EP0Data.pData = (BYTE *)USB_DeviceQualifierFS;
          } else {
            EP0Data.pData = (BYTE *)USB_DeviceQualifierHS;
          }
          len = USB_DEVICE_QUALI_SIZE;
          break;
        case USB_CONFIGURATION_DESCRIPTOR_TYPE:
          if (USB_HighSpeed) {
            pD = (BYTE *)USB_ConfigDescriptorHS;
          } else {
            pD = (BYTE *)USB_ConfigDescriptorFS;
          }
    ...
    case REQUEST_TO_INTERFACE:
      switch (SetupPacket.wValue.WB.H) {
        ...
        case HID_HID_DESCRIPTOR_TYPE:
          ...
          if (USB_HighSpeed) {
            EP0Data.pData = (BYTE *)USB_ConfigDescriptorHS + HID_DESC_OFFSET;
          } else {
            EP0Data.pData = (BYTE *)USB_ConfigDescriptorFS + HID_DESC_OFFSET;
          }
          len = HID_DESC_SIZE;
          break;
