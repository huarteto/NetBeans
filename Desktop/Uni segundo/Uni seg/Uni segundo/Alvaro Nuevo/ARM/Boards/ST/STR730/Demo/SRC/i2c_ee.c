...
*                      I2C M24C08 EEPROM, mounted on the MB403A board.
********************************************************************************
* History:
* 09/27/2005 :  V1.0
********************************************************************************
...
void I2C_EE_Init(void)
{
  ...
  GPIOi_InitStructure.GPIO_Mode = GPIO_Mode_AF_OD;
  GPIOi_InitStructure.GPIO_Pins = GPIO_PIN_14 | GPIO_PIN_15 ;
  GPIO_Init(GPIO2, &GPIOi_InitStructure);

  /* configure P2.12 and P2.13 */
  GPIOi_InitStructure.GPIO_Mode = GPIO_Mode_OUT_PP;
  GPIOi_InitStructure.GPIO_Pins = GPIO_PIN_12 | GPIO_PIN_13 ;
  GPIO_Init(GPIO2, &GPIOi_InitStructure); 
...
void I2C_EE_DeInit(void)
{
  ...
  GPIOi_InitStructure.GPIO_Mode = GPIO_Mode_IN_TRI_TTL;
  GPIOi_InitStructure.GPIO_Pins = GPIO_PIN_12 | GPIO_PIN_13 | 
...
* Description    : Waits until write opertaion has completed.  
