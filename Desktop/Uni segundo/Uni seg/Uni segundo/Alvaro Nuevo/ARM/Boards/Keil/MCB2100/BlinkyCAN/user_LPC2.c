...
WORD delay;
  ...
  MCO_InitTPDO(1,0,250,0,4,IN_digi_1);    
  // TPDO1, default ID (0x180+nodeID), 250ms event, 0ms inhibit, 4 bytes
  
  MCO_InitTPDO(2,0,100,0,4,IN_ana_1); 
  // TPDO2, default ID (0x280+nodeID), 100ms event, 20ms inhibit, 4 bytes
}
