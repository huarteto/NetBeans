 ...
 * $Id::  $
 *
 * Project: LPC315x standard 10-bit ADC driver
 *
 * Description:
 *     This file contains driver support for the LPC315x 10-bitADC
 *
 ***********************************************************************
...
#include "lpc315x_adc10b_driver.h"
