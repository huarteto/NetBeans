...
* $Id::$
*
* Project: LPC315x SD/MMC/SDIO controller driver
*
* Description:
*     This file contains driver support for the LPC315x SD/MMC/SDIO
*     controller.
*
***********************************************************************
...
#include "lpc_sdmmc.h"
#include "lpc315x_sysreg.h"
#include "lpc315x_ioconf_driver.h"
#include "lpc315x_cgu_driver.h"
#include "lpc315x_timer_driver.h"
#include "lpc315x_mci_driver.h"
...
static int prv_pull_data(MCI_CARD_INFO_T* pdev, UNS_8* pv, int cnt)
{
  ...
  while (i < cnt)
  {
    ...
    /* LPC315x maps address above 0x18000100 to FIFO to support
