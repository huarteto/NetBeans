...
#else
#define EXT_RANGE_ID_MSK_L(range_start, range_end)	((u16)(RANGE_ID_MSK((range_start), (range_end))))
#define EXT_RANGE_ID_MSK_H(range_start, range_end)	((u16)((RANGE_ID_MSK((range_start), (range_end)) >> 16) & 0x1FFF))
#define EXT_RANGE_ID_ARB_L(range_start, range_end)	((u16)(RANGE_ID_ARB((range_start), (range_end))))
#define EXT_RANGE_ID_ARB_H(range_start, range_end)	((u16)((RANGE_ID_ARB((range_start), (range_end)) >> 16) & 0x1FFF))
