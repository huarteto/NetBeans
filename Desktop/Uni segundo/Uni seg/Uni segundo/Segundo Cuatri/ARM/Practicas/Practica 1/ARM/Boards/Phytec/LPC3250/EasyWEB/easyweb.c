...
#include "LPC325x.h"      // Keil: Register definition file for LPC3250
...
{
// Keil: function replaced to handle LPC3250 A/D converter.
  unsigned int val;

  ADCON |= 0x02;                         // Start ADC Conversion
  while (!(SIC1_RSR & 0x80));            // Wait for EOC irq
