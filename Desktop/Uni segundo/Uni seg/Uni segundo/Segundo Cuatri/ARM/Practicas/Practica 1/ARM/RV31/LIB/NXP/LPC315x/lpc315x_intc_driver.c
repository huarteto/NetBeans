 ...
 * $Id::$
 *
 * Project: LPC315X interrupt driver
 *
 * Description:
 *     This file contains driver support for the LPC315X
 *     interrupt driver.
 *
 * Notes:
...
extern UNS_32 lpc315x_reset_vector;
...
static void int_write_arm_vec_table(void)
{
  ...
  dstsave = dst;
  for (src = (UNS_32 *) & lpc315x_reset_vector;
