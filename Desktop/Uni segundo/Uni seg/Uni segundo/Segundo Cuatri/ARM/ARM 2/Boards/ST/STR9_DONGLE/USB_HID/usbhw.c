...
void USB_Init (void) {
  ...
  SCU->PCGR1        |= (1 << 21);           /* GPIO7 peripheral clock enable */
  SCU->PRR1         |= (1 << 21);           /* GPIO7 peripheral not in reset */
  GPIO7->DR[0xFF*4] |= 0x20;                /* P7.5 high                     */
  SCU->GPIOOUT[7]   |= 0x0400;              /* P7.5 output - mode 1           */
  GPIO7->DDR        |= 0x20;                /* P7.5 Output                    */
}
