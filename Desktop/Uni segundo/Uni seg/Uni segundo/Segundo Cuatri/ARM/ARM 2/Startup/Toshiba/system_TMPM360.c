/******************************************************************************
 * @file:    system_TMPM360.c
 * @purpose: CMSIS Cortex-M3 Device Peripheral Access Layer Source File for the
 *           TOSHIBA 'TMPM360' Device Series 
 * @version: V2.0.2.6 (Tentative)
 * @date:    2010/06/09
 * 
...
#define OSCCR_Ready     (0x03200300UL) /* Warm-up time[OSCCR<WUPT>] = 0x32(100us @ XTALH = 8MHz) */
#define OSCCR_Val       (0x06400304UL) /* Warm-up time[OSCCR<WUPT>] = 0x64(200us @ XTALH = 8MHz) */
